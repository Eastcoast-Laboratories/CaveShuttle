...
Cave Shuttle soll sich optional mit einem Benutzerkonto bei `community.caveshuttle.z11.de` verbinden können. Dafür wird das bereits unter `/var/www/roboyard.z11/` laufende Laravel-Backend wiederverwendet und unter `/var/kunden/webs/ruben/www/community.caveshuttle.z11.de` installiert Die Highscore-Phase 2 erfordert nur gezielte Ergänzungen für `caveshuttle`; der bestehende Roboyard-Betrieb bleibt unverändert.
